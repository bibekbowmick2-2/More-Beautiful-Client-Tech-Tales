...
const Header = () => {
  ...
  return (
    <div className="navbar bg-[#080325] text-white fixed z-10 ">
      <div className="navbar-start ">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content bg-zinc-800 rounded-box z-[1] mt-3 w-52 p-2 shadow"
          >
            {link}
          </ul>
        </div>
        <a className="btn btn-ghost text-xl  ">Tech-Tales</a>
      </div>
