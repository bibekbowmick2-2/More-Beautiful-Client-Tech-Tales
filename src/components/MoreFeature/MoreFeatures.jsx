        ...
        <div style={{
            ...
            <div className="bg-[#0000008a] h-full w-full pt-10">
                ...
                <div className=' grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 py-10 gap-5'>
                    <motion.div   animate={firstAnimation} style={{backgroundColor: '#1d37f7',opacity: '0.4'}}  className="card  text-neutral-content w-[300px] lg:w-[300px] lg:-skew-y-12 mx-auto rounded-none">
                    ...
                    <motion.div  animate={secondAnimation} style={{backgroundColor: '#1d37f7',opacity: '0.4'}} className="card  text-neutral-content w-[300px] lg:w-[300px]  mx-auto rounded-none">
                    ...
                    <motion.div animate={thirdAnimation} style={{backgroundColor: '#1d37f7',opacity: '0.4'}} className="card text-neutral-content w-[300px] lg:w-[300px] lg:skew-y-12 mx-auto rounded-none">
                        <div className="card-body items-center text-center">
